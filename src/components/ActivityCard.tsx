import { Activity } from "@/app/components/StravaIntegration";
...
const ActivityCard = ({
  ...
  return (
    <Card
      className={`p-6 hover:shadow-[var(--shadow-card)] transition-all bg-card border-border ${
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-4 text-sm mb-4">
        ...
        <div>
          ...
          <p className="font-semibold text-lg">{moving_time}</p>
        </div>
        <div>
          <p className="text-muted-foreground mb-1 flex items-center gap-1">
          ...
          <p className="font-semibold text-lg">{total_elevation_gain}m</p>
        </div>
        <div>
          <p className="text-muted-foreground mb-1 flex items-center gap-1">
